...
bot.command('start', (ctx) => {
  ...
  Участников, сумма вкладов которых равна нулю , можно просто перечислить через запятую, не указывая ноль. Пожалуйста, не используй лишние символы и слова при вводе. 
